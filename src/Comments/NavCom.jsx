    ...
    <nav className="bg-white fixed top-0 inset-x-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div>
            <NavLink to="/" className="flex items-center gap-2 text-sky-500">
          ...
          <div className="-mr-2 flex md:hidden shadow-md">
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-800 hover:text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 focus:text-white transition duration-300 ease-in-out"
        ...
        <div
          ...
          } md:hidden lg:hidden bg-sky-400 py-2 px-2 shadow-sm fixed top-0 h-full w-56 transition-transform duration-300 ease-in-out`}
        >
